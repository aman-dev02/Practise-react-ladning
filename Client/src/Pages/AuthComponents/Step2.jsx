  ...
  return (
   ...
   >
      <div className="w-full max-w-md flex flex-col">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Enter Your Information</h2>
        ...
        <div className="mb-4">
        <label className="block text-sm mb-2 dark:text-white">Profile Picture:</label>
          ...
          {uploadedImage ? (
            ...
            <div className="mb-2">
              ...
              <input
                ...
                className="block w-full outline-none  mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
